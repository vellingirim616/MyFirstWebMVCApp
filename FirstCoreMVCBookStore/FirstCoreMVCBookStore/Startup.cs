...
namespace FirstCoreMVCBookStore
{
   ...
   //         app.UseStaticFiles(new StaticFileOptions()   //This is used when static files are present other than wwwroot.
   //         {
   //             FileProvider = new PhysicalFileProvider(Directory.GetCurrentDirectory() + "MyTempPath"),
   //             RequestPath = "/MyTempPath"   //MyTempPath is the folder which contains static files. 
			//}) ; 
